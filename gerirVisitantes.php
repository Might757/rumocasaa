  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center main-title pb-2">
          ...
          <div class="membros-icon"><i class="fa fa-user"></i></div>
          <h1 class="my-title">VER <span class="green-text">VISITANTES</span></h1>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-8" style="margin: auto;">
          <div class="col-12" style="margin: auto;">
            ...
            <form id="form-pesquisa" action="db/getVisitantes.php" method="POST">
              <div class="form-row">
      ...
      <div class="row">
        <div class="col-12" style="margin: auto;">
        <a href="#" id="form-switch-table-Cursos" class="switch-forms"><i class="fas fa-sync-alt form-switch-icon"></i> Trocar para Cursos</a>
            <a href="#" id="form-switch-table-Escolas" class="switch-forms" style="display: none; "><i class="fas fa-sync-alt form-switch-icon"></i> Trocar para Escolas</a>
            <div class="table-responsive-sm">
              <table class="table" id="tableEscolas">
                <thead>
                  <tr class="table-top">
                    <th scope="col">Escolas</th>
                    <th scope="col">Número de Visitantes</th>
                  </tr>
                </thead>
                <tbody id="dados" class="table-content"></tbody>
              </table>
              <table class="table" id="tableCursos" style="display: none;">
                <thead>
                  <tr class="table-top">
                ...
                <tbody id="dadosCursos" class="table-content"></tbody>
              </table>
            </div>
            </div>
        </div>
    ...
    $(document).ready(function(){
      ...
      function mostrarNoticias(txtPesquisa){
        ...
        $.ajax({
          url: "db/getVisitantes.php?num=1",
          method: "POST",
          dataType: "text",
          data: {
            page:page,
      ...
      $("#form-switch-table-Cursos").on("click", function(e){
        // Desativa o default do botão
        e.preventDefault();
        $('#form-switch-table-Cursos').hide();
        $('#form-switch-table-Escolas').show();
        $('#tableEscolas').hide();
        $('#tableCursos').show();
        $(".display-error").css("display","none");
        $('#loading-imageAdd').hide();
      ...
      $("#form-switch-table-Escolas").on("click", function(e){
        // Desativa o default do botão
        e.preventDefault();
        $('#form-switch-table-Cursos').show();
        $('#form-switch-table-Escolas').hide();
        $('#tableEscolas').show();
        $('#tableCursos').hide();
        $(".display-error").css("display","none");
        $('#loading-imageAdd').hide();
      ...
      function mostrarCursos(txtPesquisa){
        ...
        // Envia para o ficheiro getNoticias.php através do método POST os valores inseridos pelo utilizador
        $.ajax({
          url: "db/getVisitantes.php?num=2",
          method: "POST",
          dataType: "text",
          data: {
            txtPesquisa:txtPesquisa
